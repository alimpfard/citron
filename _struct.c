 ...
 */
ffi_type *
ctr_ffi_type_get_format_splat (char **format, size_t * this_size)
{
  switch (**format)
    {
...
int
ctr_ffi_type_struct_sizeof (char *format)
...
ffi_type *
ctr_create_ffi_type_descriptor (char *format)
{
  size_t size;
...
ffi_type *
ctr_create_ffi_type_descriptor_ (char *format, int member_count)
{
...
int
ctr_create_ffi_str_descriptor (ffi_type * type, char *buf)
{
...
main (void)
{
  ...
  printf ("layout:\n a: %d\n b: %d\n d: %d\n e: %d\n c: %d\n f: %d\n",
	  ...
	  offsetof (struct test_str, d), offsetof (struct test_str, e), offsetof (struct test_str, c), offsetof (struct test_str, f));
