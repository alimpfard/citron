...
void
ctr_ccomp_free_env (environment * ctx)
{
...
void
ctr_ccomp_env_pprint_popped (environment * env, int indent)
{
  if (!env)
    return;
  environment *ctx = env;
...
void
ctr_ccomp_env_update_block (environment * env, ctr_tnode * node)
{
  //TODO
}

void
ctr_ccomp_env_update_assign (environment ** env, ctr_tlistitem * nodes)
{
...
int
ctr_ccomp_rec_nodes_indeterministic_level (ctr_tlistitem * nodes)
{
  int max_level = 0;
...
ctr_tlistitem *
ctr_ccomp_nodes_as_literal (ctr_tlistitem * li)
{
...
int
ctr_ccomp_print_series (ctr_tlistitem * item, char space)
{
  char i;
  char spacer[3];
  if (space != '\0')
...
int
ctr_ccomp_print_series_raw (ctr_tlistitem * item, char space)
{
  char i;
  char spacer[3];
  if (space != '\0')
 ...
 */
ctr_object *
ctr_ccomp_return (ctr_tnode * node)
{
  char wasReturn = 0;
  ctr_tlistitem *li;
  ctr_object *e;
...
int
ctr_ccomp_str_replace (char *str, char o, char r)
{
  char *ix = str;
  int n = 0;
 ...
 */
ctr_object *
ctr_ccomp_message (ctr_tnode * paramNode)
{
  int sticky = 0;
  char wasReturn = 0;
  ctr_object *result;
 ...
 */
ctr_object *
ctr_ccomp_assignment (ctr_tnode * node)
{
  char wasReturn = 0;
...
void
ctr_ccomp_print_block (ctr_tnode * node)
{
 ...
 */
ctr_object *
ctr_ccomp_expr (ctr_tnode * node, char *wasReturn)
{
  ctr_object *result;
  switch (node->type)
    {
...
ctr_object *
ctr_ccomp_run (ctr_tnode * program)
{
