 ...
 */
ctr_object *
ctr_fiber_create (ctr_object * myself, ctr_argument * argumentList)
{
...
ctr_object *
ctr_fiber_spawn (ctr_object * myself, ctr_argument * argumentList)
{
  ...
  ctr_internal_object_add_property (fiberObj,
				    ...
				    ("fiberId"), ctr_build_number_from_float (numFibers), CTR_CATEGORY_PRIVATE_PROPERTY);
  return fiberObj;
}
...
ctr_fiber_yield (ctr_object * myself, ctr_argument * argumentList)
{
  ...
  ctr_internal_object_set_property (myself,
				    ctr_build_string_from_cstring
				    ("yielded"), argumentList->object ? argumentList->object : CtrStdNil, CTR_CATEGORY_PRIVATE_PROPERTY);
  fiberYield ();
 ...
 */
ctr_object *
ctr_fiber_join_all (ctr_object * myself, ctr_argument * argumentList)
{
 ...
 */
ctr_object *
ctr_fiber_join (ctr_object * myself, ctr_argument * argumentList)
{
  waitForFiber ((int)
		ctr_internal_object_find_property (myself, ctr_build_string_from_cstring ("fiberId"), CTR_CATEGORY_PRIVATE_PROPERTY)->value.nvalue);
  ctr_object *y = ctr_internal_object_find_property (myself,
...
ctr_object *
ctr_fiber_tostring (ctr_object * myself, ctr_argument * argumentList)
{
 ...
 */
ctr_object *
ctr_fiber_assign (ctr_object * myself, ctr_argument * argumentList)
{
...
ctr_fiber_begin_init ()
{
  ...
  ctr_internal_create_func (CtrStdFiber, ctr_build_string_from_cstring ("wait"), &ctr_fiber_join);
