...
ctr_generator_make (ctr_object * myself, ctr_argument * argumentList)
{
  ...
  switch (arg->info.type)
    ...
    default:
      {				//repeat | map
	if (ctr_reflect_get_primitive_link (arg) == CtrStdMap)
	  {			//map
...
ctr_object *
ctr_generator_internal_inext (ctr_generator * genny, int gtype, ctr_generator * ogenny, int ogtype)
{
...
ctr_object *
ctr_generator_internal_tostr (ctr_generator * gen, int gtype)
{
  switch (gtype)
    {
    case CTR_REPEAT_GENNY:
...
ctr_generator *
ctr_internal_generator_copy (ctr_generator * genny, int gtype)
{
...
ctr_generator *
ctr_unwrap_generator (ctr_mapping_generator * mg)
{
...
void
ctr_condense_generator (ctr_generator * gen, int ty)
{
  switch (ty)
    {
    case CTR_REPEAT_GENNY:
...
ctr_mapping_generator *
ctr_combine_generators (ctr_mapping_generator * genp, ctr_mapping_generator * genc)
{
