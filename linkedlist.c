...
ll *
llconcat_and_add (int head, int last, ll * llv)
{
...
int
llput (ll * llv, size_t index, int value)
{
  ll *llc = llv;
  while (llc && index)
    {
...
ll *
llslice (ll * llv, int start, int end)
{
  while (start)
    {
      assert (llv);
