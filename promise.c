...
ctr_object *
ctr_promise_make (ctr_object * myself, ctr_object * target, ctr_argument * argumentList, ctr_object * receiver)
{
...
ctr_object *
ctr_promise_then (ctr_object * myself, ctr_object * target)
{
  ctr_resource *res = ctr_heap_allocate (sizeof (*res));
  static struct ctr_promise_entry sentry = {
    .next = NULL,
...
ctr_object *
ctr_promise_then_ (ctr_object * myself, ctr_argument * argumentList)
{
  return ctr_promise_then (myself, argumentList->object);
}

ctr_object *
ctr_promise_pass_message (ctr_object * myself, ctr_argument * argumentList)
{
  ctr_argument *args = ctr_heap_allocate (sizeof (*args)), *cargs = args;
  while (argumentList)
    {
...
ctr_object *
ctr_promise_dummy (ctr_object * myself, ctr_argument * argumentList)
{
  ctr_argument *args = ctr_heap_allocate (sizeof (*args));
...
ctr_object *
ctr_promise_wait (ctr_object * myself, ctr_argument * argumentList)
{
