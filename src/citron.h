...
#define CTR_CATEGORY_PUBLIC_PROPERTY                                            \
    0 /* same, all properties are PRIVATE, except those in CtrStdWorld, this is \
...
ctr_object*
ctr_ccomp_get_stub(ctr_object* (*nfunc)(ctr_object*, ctr_argument*),
    ctr_object* receiver,
    ctr_argument* args);                      // stub generator lookup table
...
CTR_H_DECLSPEC ctr_object* CtrStdBreak;        //!< Internal Flow representation for
                                               //!< break : stop the current iteration
CTR_H_DECLSPEC ctr_object* CtrStdContinue;     //!< Internal Flow representation for continue : skip the
                                               //!< current iteration
CTR_H_DECLSPEC ctr_object* CtrStdExit;         //!< Internal Flow representation for
                                               //!< exit : exit program on this message
...
CTR_H_DECLSPEC char
    ignore_in_trace[CTR_TRACE_IGNORE_LENGTH]
                   [CTR_TRACE_IGNORE_VEC_DEPTH]; // ignore named files.
...
ctr_object* ctr_string_html_escape(ctr_object* myself,
    ctr_argument* argumentList);
// ctr_object* ctr_string_literal_escape(ctr_object* myself, ctr_argument*
// argumentList);
...
CTR_H_DECLSPEC ctr_object* (*ctr_secpro_eval_whitelist[64])(ctr_object*,
    ctr_argument*);
...
// ctr_object* ctr_reflect_dump_function(ctr_object* myself, ctr_argument*
// argumentList);
...
CTR_H_DECLSPEC ctr_string CTR_CLEX_KW_ME_SV, CTR_CLEX_KW_THIS_SV,
    CTR_CLEX_US_SV, CTR_CLEX_KW_RESPONDTO_SV;
CTR_H_DECLSPEC ctr_object CTR_CLEX_KW_ME, CTR_CLEX_KW_THIS, CTR_CLEX_US,
    CTR_CLEX_KW_RESPONDTO;
