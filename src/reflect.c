    ...
    ctr_argument* argumentList)
{
    ...
    case CTR_OBJECT_TYPE_OTBLOCK:
        ...
        type_descriptor = ctr_invoke_variadic(type_descriptor, &ctr_string_concat, 1,
    ...
    ctr_argument* argumentList)
{
    ...
    case CTR_OBJECT_TYPE_OTOBJECT:
        ...
        ctr_reflect_map_type_descriptor = ctr_string_eval(ctr_build_string_from_cstring(
    ...
    ctr_argument* argumentList)
{
    ...
    ctr_mapitem *whead = worldprops->head,
                *newhead = (newProps->head = ctr_heap_allocate(sizeof(ctr_mapitem)));
    ...
    ctr_argument* argumentList)
{
    ...
    if (ret)
        return ret;
    ctr_object* ns_type = ns->lexical_name
        ? ns->lexical_name
