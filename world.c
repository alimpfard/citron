 ...
 */
char *
ctr_internal_readfp (FILE * fp, uint64_t * total_size)
{
  char *prg;
  char ch;
 ...
 */
void
ctr_internal_object_set_property (ctr_object * owner, ctr_object * key, ctr_object * value, int is_method)
{
 ...
 */
void
ctr_internal_object_set_property_with_hash (ctr_object * owner, ctr_object * key, uint64_t hashKey, ctr_object * value, int is_method)
{
...
#ifdef withBoehmGC
void
ctr_finalize_clear (GC_PTR obj, GC_PTR user_data)
{
  ctr_object *o = obj;
  if (o->release_hook)
...
// __attribute__ ((always_inline))
ctr_object *
ctr_internal_create_mapped_object_shared (int type)
{
  ctr_object *o;
...
// __attribute__ ((always_inline))
ctr_object *
ctr_internal_create_mapped_object_unshared (int type)
{
  ctr_object *o;
 ...
 */
ctr_object *
ctr_internal_create_standalone_object (int type)
{
...
// __attribute__ ((always_inline))
ctr_object *
ctr_internal_create_mapped_standalone_object (int type, int shared)
{
  ctr_object *o;
  o = shared == 1 ? ctr_heap_allocate_shared (sizeof (ctr_object)) : ctr_heap_allocate_typed_ (sizeof (ctr_object), type);
 ...
 */
void
ctr_internal_delete_standalone_object (ctr_object * o)
{
 ...
 */
void
ctr_internal_create_func (ctr_object * o, ctr_object * key, ctr_object * (*func) (ctr_object *, ctr_argument *))
{
...
ctr_internal_cast2number (ctr_object * o)
{
  ...
  if (CtrStdFlow)
    ...
    {
      CtrStdFlow =
	ctr_format_str ("ENo implicit cast arises from the use of type %$ to type Number", ctr_send_message_blocking (numObject, "type", 4, NULL));
      return ctr_build_number_from_float ((ctr_number) 0);
    }
  return numObject;
}
...
ctr_initialize_world ()
{
  ...
  ctr_internal_create_func (CtrStdObject, ctr_build_string_from_cstring (CTR_DICT_EITHEROR), &ctr_bool_either_or);
  ...
  ctr_internal_create_func (CtrStdNumber, ctr_build_string_from_cstring ("negate"), &ctr_number_negate);
  ...
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("imap:"), &ctr_string_imap);
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("filter:"), &ctr_string_filter);
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("reIndexOf:"), &ctr_string_re_index_of);
  ...
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("reLastIndexOf:"), &ctr_string_re_last_index_of);
  ...
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("p/:s/:o/:"), &ctr_string_reg_replace);
  ctr_internal_create_func (CtrStdString, ctr_build_string_from_cstring ("p/:s/:"), &ctr_string_reg_replace);
  ...
  ctr_internal_create_func (CtrStdBlock, ctr_build_string_from_cstring ("applyAll:"), &ctr_block_runall);
  ...
  ctr_internal_create_func (CtrStdArray, ctr_build_string_from_cstring ("any"), &ctr_array_any);
  ctr_internal_create_func (CtrStdArray, ctr_build_string_from_cstring ("all"), &ctr_array_all);
  ctr_internal_create_func (CtrStdArray, ctr_build_string_from_cstring ("any:"), &ctr_array_any);
  ctr_internal_create_func (CtrStdArray, ctr_build_string_from_cstring ("all:"), &ctr_array_all);
  ...
  ctr_internal_object_add_property (CtrStdFile, CTR_FILE_STDIN_STR, CTR_FILE_STDIN, 0);
  ctr_internal_object_add_property (CtrStdFile, CTR_FILE_STDOUT_STR, CTR_FILE_STDOUT, 0);
  ctr_internal_object_add_property (CtrStdFile, CTR_FILE_STDERR_STR, CTR_FILE_STDERR, 0);
  ...
  ctr_internal_create_func (CtrStdCommand, ctr_build_string_from_cstring ("serve_ipv4:"), &ctr_command_accepti4);
  ...
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("mapPropertiesOf:"), &ctr_reflect_dump_context_prop);
  ...
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("isObject:constructibleBy:"), &ctr_reflect_check_bind_valid_v);
  ...
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("registerInstrumentor:forObject:"), &ctr_reflect_register_instrumentor);
  ...
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("run:inContext:forObject:arguments:"),
			    &ctr_reflect_run_for_object_inside_ctx);
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("run:inContextAsWorld:arguments:"),
			    &ctr_reflect_run_for_object_in_ctx_as_world);
  ctr_internal_create_func (CtrStdReflect, ctr_build_string_from_cstring ("run:inContextAsMain:arguments:"),
...
ctr_object *
ctr_get_appropriate_catch_all (char *message, long vlen, int argCount)
{
  if (vlen == 1)
...
static struct ctr_internal_tag_ll *ctr_internal_tag_whitelist_list = INITIALISE_TAG_DESCR (&ctr_array_internal_zip,
											   &ctr_ast_each,
											   &ctr_ast_eachv,
											   &ctr_ast_evaluate,
											   &ctr_ast_flex,
...
int
ctr_internal_check_tag_whitelisted (void *ptr)
{
...
void
ctr_internal_tag_whitelist (void *ptr)
{
  if (!ptr)
    return;
...
no_instrum:;
  ...
  if (!methodObject)
      ...
      if (vlen == catch_all_v && message[9] == ':' && strcmp (message, catch_all) == 0)
	{
	  ...
	  CtrStdFlow =
	    ctr_format_str ("E" CTR_DICT_RESPOND_TO_AND " calls itself with initiator ‘%.%s’ for object named ‘%S’", msgLen__, msgName__, s);
	  CTR_THREAD_UNLOCK ();
	  msgName__ = message;
	  msgLen__ = vlen;
...
ctr_overload_set *
ctr_internal_next_bucket (ctr_overload_set * set, ctr_argument * arg)
{
  if (!set)
    return NULL;
  if (!arg)
